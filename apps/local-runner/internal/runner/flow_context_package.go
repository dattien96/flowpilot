...
// BuildFlowContextPackageCtx directly so a future context-aware source (e.g.
// Task-195's MCP-backed source) can observe caller cancellation/timeout.
...
// ctx to propagate so a future context-aware source (e.g. Task-195's
// MCP-backed source) can observe caller cancellation/timeout.
