...
func TestLoadBuiltinPack(t *testing.T) {
	...
	for _, want := range []string{"vibe-ingest", "vibe-sprint", "vibe-owner-debate", "vibe-cp-ingest", "task-harness", "cp-harness", "cp-harness-smoke", "bug-harness", "bug-plan-harness"} {
