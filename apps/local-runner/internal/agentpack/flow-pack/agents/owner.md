...
Read only what you need (SS slice, TDD signatures, TurnResult/gate detail, and the failing file scope around the violation). Do not edit files. Do not run git commit. Do not change the SS.
