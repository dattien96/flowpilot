...
export interface LocalRunnerEngineToolStatus {
  tool: string;
  version?: string;
...
export interface LocalRunnerEngineCapabilityProfile {
  hasGitNexus: boolean;
  hasRTK: boolean;
  hasNode: boolean;
  hasTests: boolean;
...
export interface LocalRunnerEngineSkillProviderStatus {
  provider: string;
  path: string;
  present: boolean;
  current: boolean;
...
export interface LocalRunnerEngineSkillStatus {
  name: string;
  providers: LocalRunnerEngineSkillProviderStatus[];
}

export interface LocalRunnerEngineSkillPackState {
  packVersion: number;
  installed: boolean;
  current: boolean;
  skills: LocalRunnerEngineSkillStatus[];
}

export interface LocalRunnerEngineInitStepResult {
  step: string;
  outcome: string;
  detail?: string;
  errorMessage?: string;
...
export interface LocalRunnerEngineInitResult {
  trigger: string;
  status: string;
  skipped: boolean;
  skipReason?: string;
  ...
  steps: LocalRunnerEngineInitStepResult[];
}

export interface LocalRunnerEngineStatus {
  projectId: string;
  workingDirectory: string;
  initialized: boolean;
  tooling: LocalRunnerEngineToolStatus[];
  capability: LocalRunnerEngineCapabilityProfile;
  skillPack: LocalRunnerEngineSkillPackState;
  lastInit: LocalRunnerEngineInitResult | null;
  warnings?: string[];
}
