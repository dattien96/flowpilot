...
exports.stepDefinitionRequiresModel = stepDefinitionRequiresModel;
exports.stepDefinitionListSubtitle = stepDefinitionListSubtitle;
...
const BEHAVIOR_IDS_REQUIRING_AGENT = new Set(["agent.delegate"]);
function stepDefinitionRequiresModel(behaviorId) {
    if (!behaviorId)
        return true;
    return BEHAVIOR_IDS_REQUIRING_AGENT.has(behaviorId);
}
function stepDefinitionListSubtitle(step) {
