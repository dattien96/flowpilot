...
(0, node_test_1.default)("collapses once three or more notifications are active", () => {
    strict_1.default.equal((0, runToastGrouping_1.shouldCollapseToasts)(runToastGrouping_1.COLLAPSIBLE_TOAST_THRESHOLD - 1), false);
