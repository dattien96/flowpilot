...
- Related Documents: [Task-078: Cross-Provider Chat Handoff](../done/Task-078-Cross-Provider-Chat-Handoff.md), [Task-313](./Task-313-ChatId-Data-Model-Transcript-Store-Timeline.md), [Task-315](./Task-315-TUI-Chat-Switch-Surface.md)
- Replaces: `None`
