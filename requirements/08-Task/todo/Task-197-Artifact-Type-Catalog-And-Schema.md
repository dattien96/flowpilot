...
- Parent Documents: [CP-45: Generic Artifact Types And User-Scoped Artifact Instances](../../07-Coding-Plan/todo/CP-45-Generic-Artifact-Types-And-Instances.md), [SD-22: Pluggable Context Source Registry](../../06-System-Tech-Design/SD-22-Pluggable-Context-Source-Registry.md), [SS-13: AI-Followable Document Contract](../../05-System-Specs/SS-13-AI-Followable-Document-Contract.md)
...
- `T-1` `ArtifactType` is system-owned in v1; user authoring starts at `ArtifactInstance`, not custom type creation.
...
- `Q-1` Should type catalog rows be seeded only through migrations, or also mirrored from built-in pack metadata at startup?
