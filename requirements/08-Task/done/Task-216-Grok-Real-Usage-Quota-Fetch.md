...
- upstream docs updated: `requirements/08-Task/inprogress/Task-210-Grok-Account-Model-Detect-Connect-Switch-Quota.md` (`Q-1` annotated), `requirements/07-Coding-Plan/inprogress/CP-46-Grok-Build-Controlled-Adapter-Over-ACP.md` (`Q-5` annotated).
