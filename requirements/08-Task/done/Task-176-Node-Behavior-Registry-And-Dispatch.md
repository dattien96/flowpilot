...
- upstream docs updated: [CP-42](../../07-Coding-Plan/done/CP-42-Flow-Pack-And-Generic-Node-Behavior-Refactor.md) progress notes (link path corrected — pointed at a nonexistent `todo/` copy before). [CA-149](../../../change-audit/CA-149-node-behavior-registry-and-dispatch.md) is a dangling reference — no `requirements/change-audit/` directory exists anywhere in this checkout.
