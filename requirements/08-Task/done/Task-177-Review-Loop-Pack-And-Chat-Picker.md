...
- upstream docs updated: [CP-42](../../07-Coding-Plan/done/CP-42-Flow-Pack-And-Generic-Node-Behavior-Refactor.md) progress notes (link path also corrected here — it pointed at a nonexistent `todo/` copy before). CA-152/156/158/160 references above remain dangling — see the doc-gap note.
