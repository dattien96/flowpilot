...
- Reviewers: `TBD`
- Created: `2026-07-03`
- Last Updated: `2026-08-11` (**code done** — P-1→P-6 shipped; verification = manual steps in [CP-43-Test-Steps](./CP-43-Test-Steps.md))
...
- [x] `P-5` **Done** (code, 2026-08-11) via [Task-188](../../08-Task/done/Task-188-Canonical-Head-Packing-And-Admin.md) + [CA-435](../../change-audit/CA-435-cp43-p5-pack-budget-and-admin-scope-diff.md): `canonical.head` priority 1; render budget drops history with log; panel ScopeDiff + feature list API. **Verification:** B19/B20 manual steps in [CP-43-Test-Steps](./CP-43-Test-Steps.md) — tick when convenient, not a code blocker.
- [x] `P-6` **Done** (code, 2026-08-11) via [Task-259](../../08-Task/done/Task-259-Source-Dependence-Context-Source.md) + [BUG-323](../../09-BugFix/done/BUG-323-GitNexus-Structure-Provider-Always-Returns-Empty.md) + [CA-434](../../change-audit/CA-434-symbol-input-and-source-dependence-task259.md). **Verification:** B12/B23 in CP-43-Test-Steps.
