...
- Related Documents: [Task-204: Wire Production MCP Driver Adapter](../../08-Task/done/Task-204-Wire-Production-MCP-Driver-Adapter.md) (follow-up, outside CP-44's own DOD-5 scope — production Google Drive backing for mcp.driver), [BUG-266: Changeledger Feature History Order Non-Deterministic](../../09-BugFix/done/BUG-266-Changeledger-Feature-History-Order-Nondeterministic-On-Equal-CommittedAt.md) (side-fix discovered while writing Task-192's golden test), [CP-41: RAG Harness Flow Mode](./CP-41-RAG-Harness-Flow-Mode.md), [CP-42: Flow Pack And Generic Node Behavior Refactor](../done/CP-42-Flow-Pack-And-Generic-Node-Behavior-Refactor.md) (mẫu registry gốc; **tiếp quản CP-42 `P-4`** "context packages become typed artifacts with declared bindings" — trước đây parked ở CP-43 §11, nay là charter của CP-44), [CP-43: Change Contract And Canonical Intent Signature](./CP-43-Change-Contract-And-Canonical-Intent-Signature.md) (consumer — Canonical Head là 1 source cắm vào CP-44), [Task-168: Flow Mode Context Package Contract](../../08-Task/done/Task-168-Flow-Mode-Context-Package-Contract.md), [Task-176: Node-Behavior Registry And Dispatch](../../08-Task/done/Task-176-Node-Behavior-Registry-And-Dispatch.md), [BUG-243: Flow Mode Validate And Audit Behaviors Disconnected](../../09-BugFix/done/BUG-243-Flow-Mode-Validate-And-Audit-Behaviors-Disconnected-From-Task-170-171.md)
- Replaces: `None`
...
- `requirements/07-Coding-Plan/done/CP-41-RAG-Harness-Flow-Mode.md`
