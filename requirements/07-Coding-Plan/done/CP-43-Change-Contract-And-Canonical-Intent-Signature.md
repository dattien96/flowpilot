...
- Phase: `coding_plan`
- Status: `done` (2026-08-28 — code + verification complete; F8 live run-174539)
- Owner: `FlowPilot`
- Reviewers: `TBD`
- Created: `2026-07-03`
- Last Updated: `2026-08-28` (**done** — verification closed via [CP-43-Test-Steps](./CP-43-Test-Steps.md) F8 run-174539)
...
- Child Documents: [Task-184: Change Contract Capture](../../08-Task/done/Task-184-Change-Contract-Capture.md) (P-1, **done**), [Task-185: Scope-Drift Detection](../../08-Task/done/Task-185-Scope-Drift-Detection.md) (P-2, **done**), [Task-186: Canonical Head And Intent Signature](../../08-Task/done/Task-186-Canonical-Head-And-Intent-Signature.md) (P-3, **done**), [Task-187: Superseding Decision Records And Retire](../../08-Task/done/Task-187-Superseding-Decision-Records-And-Retire.md) (P-4, **done**), [Task-188: Canonical-Head Packing And Admin Visibility](../../08-Task/done/Task-188-Canonical-Head-Packing-And-Admin.md) (P-5, **done** 2026-08-11 — [CA-435](../../change-audit/CA-435-cp43-p5-pack-budget-and-admin-scope-diff.md)), [Task-259: source.dependence Context Source](../../08-Task/done/Task-259-Source-Dependence-Context-Source.md) (P-6, **done** 2026-08-11 — [CA-434](../../change-audit/CA-434-symbol-input-and-source-dependence-task259.md))
- Related Documents: [CP-43-CATALOG: Context Source Catalog And Test Log](./CP-43-Context-Source-Catalog-And-Test-Log.md) (companion — full source catalog, per-source test battery, live E2E), [CP-54: Locus-Anchored Relevance Retrieval](../todo/CP-54-Locus-Anchored-Context-Relevance.md) (**downstream** — tầng retrieval/ranking nằm dưới `feature.history`/`chat.summary`; giải context-dilution khi một `feature_key` gom nhiều chủ đề con, đảo trục truy hồi sang locus vùng-code), [CP-55: Flow-First Preflight Contract, Context Retrieval, And Canonical Acceptance](../todo/CP-55-Flow-First-Preflight-Contract-Context-Retrieval-And-Canonical-Acceptance.md) (**downstream, done 2026-07-31** — re-architects khi nào/bằng cách nào Canonical Head này thực sự mutate: đóng băng scope trước khi coder chạy (`contract.freeze`, tách khỏi `Contract`/legacy parser CP-43 này định nghĩa), hoãn mutation Canonical Head tới đúng lúc Flow terminal "done" thay vì mỗi gate pass, và triển khai tầng ranking CP-54 nói trên vào Flow production thật lần đầu tiên), [CP-44: Pluggable Context Source Registry](./CP-44-Pluggable-Context-Source-Registry.md) (**dependency** — Canonical Head is a context source cắm vào CP-44's registry; CP-44 lands first), [SD-17: Context And Regression Engine](../../06-System-Tech-Design/SD-17-Context-And-Regression-Engine.md) (D-11), [CP-35: Context And Regression Engine Rollout](../done/CP-35-Context-And-Regression-Engine-Rollout.md), [CP-23: Context Control & Wrong-Way Detection](./CP-23-Auto-Learn-To-Skill.md), [CP-32: UnitTest Rule](../done/CP-32-UnitTest-Rule.md), [CP-42: Flow Pack And Generic Node Behavior Refactor](../done/CP-42-Flow-Pack-And-Generic-Node-Behavior-Refactor.md) (P-8 residual only, §11; P-4 typed-context-bindings re-homed to CP-44), [BUG-243: Flow Mode Validate And Audit Behaviors Disconnected From Task-170/171](../../09-BugFix/done/BUG-243-Flow-Mode-Validate-And-Audit-Behaviors-Disconnected-From-Task-170-171.md) (**un-folded 2026-07-08** → standalone, lands first; no longer CP-43 scope)
- Replaces: `None`
...
### 4.6 `P-6` `source.dependence` context source — blast-radius from the declared contract (added 2026-07-17) → [Task-259](../../08-Task/done/Task-259-Source-Dependence-Context-Source.md) (**code done** 2026-08-11, [CA-434](../../../change-audit/CA-434-symbol-input-and-source-dependence-task259.md))

`P-2` already computes drift with `structure.Dependents` **inside the flow gate** (a warn/block rule). `P-6` surfaces the *same* GitNexus signal as a **context source** for the prompt instead of a gate: once a run has a Change Contract (`P-1`), the `source.dependence` source reads its `declared_paths`/`declared_symbols`, **normalizes them to concrete impact targets** (symbols first, then concrete code files mapped to symbols; dir-buckets/globs/doc files dropped), and for each runs `structure.Provider.Dependents` (`npx gitnexus impact <symbol> --repo <repo>`) to render a bounded blast-radius block — "changing this declared target affects these symbols/files/flows". This answers the owner's question *"đã handle context-depend-code qua gitnexus chưa — đổi cái này ảnh hưởng cái nào"* at the context layer.
...
- [x] `P-2` **Done** (v1 file-level scope + GitNexus symbol severity via [CA-434](../../change-audit/CA-434-symbol-input-and-source-dependence-task259.md), 2026-08-11). `r-scope` warns on out-of-scope paths; blocks when `HighSeverity` true (symbol query via `GitNexusQueryTargetsForPath`). **Known v1 limit:** no symbol extraction from diff hunks — deliberate per SD-21 D-2.
- [x] `P-3` **Done** via [Task-186](../../08-Task/done/Task-186-Canonical-Head-And-Intent-Signature.md), 2026-07-13 (+ [BUG-280](../../09-BugFix/done/BUG-280-Features-Never-Link-To-Governing-Docs-So-Canonical-Head-Stays-Spec-Less.md)). Flow finalize timing via CP-55.
- [x] `P-4` **Done** via [Task-187](../../08-Task/done/Task-187-Superseding-Decision-Records-And-Retire.md), 2026-07-13. FoldDecisions keyword heuristic is a **known limitation**, not an open code gap.
- [x] `P-5` **Done** (code, 2026-08-11) via [Task-188](../../08-Task/done/Task-188-Canonical-Head-Packing-And-Admin.md) + [CA-435](../../change-audit/CA-435-cp43-p5-pack-budget-and-admin-scope-diff.md): `canonical.head` priority 1; render budget drops history with log; panel ScopeDiff + feature list API. **Verification:** B19/B21/B22 live in [CP-43-Test-Steps](./CP-43-Test-Steps.md) (B20 long-history log = residual).
- [x] `P-6` **Done** (code, 2026-08-11; verification, 2026-08-28) via [Task-259](../../08-Task/done/Task-259-Source-Dependence-Context-Source.md) + [BUG-323](../../09-BugFix/done/BUG-323-GitNexus-Structure-Provider-Always-Returns-Empty.md) + [CA-434](../../change-audit/CA-434-symbol-input-and-source-dependence-task259.md). **Verification:** B12/F8 run-174539 in CP-43-Test-Steps.
