...
- upstream docs updated: [CP-51 Phase A/B Timeline And Verification Log](../../07-Coding-Plan/inprogress/CP-51-PhaseAB-Timeline-And-Verification-Log.md) §6 "Gaps known" — the "Grok restore specifically is a known, pre-existing, larger gap" bullet is superseded by this fix; updated in the same pass as this doc.
