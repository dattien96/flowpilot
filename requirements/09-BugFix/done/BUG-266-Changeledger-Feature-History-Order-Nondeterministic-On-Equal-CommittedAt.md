...
- Related Documents: [CP-44: Pluggable Context Source Registry](../../07-Coding-Plan/done/CP-44-Pluggable-Context-Source-Registry.md), [Task-192: Migrate Built-in Context Sources](../../08-Task/done/Task-192-Migrate-Builtin-Context-Sources.md) (discovered while writing its behavior-preserving golden test)
- Replaces: `None`
