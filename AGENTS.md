...
This project is indexed by GitNexus as **flowpilot** (7307 symbols, 17375 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
