...
This project is indexed by GitNexus as **flowpilot** (5363 symbols, 12339 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
