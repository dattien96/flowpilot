...
This project is indexed by GitNexus as **flowpilot** (4634 symbols, 10597 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
