...
This project is indexed by GitNexus as **flowpilot** (7356 symbols, 17655 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
