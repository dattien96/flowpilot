...
This project is indexed by GitNexus as **flowpilot** (9024 symbols, 21001 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
