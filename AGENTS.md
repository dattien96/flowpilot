...
This project is indexed by GitNexus as **flowpilot** (5067 symbols, 10251 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
