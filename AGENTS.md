...
This project is indexed by GitNexus as **flowpilot** (740 symbols, 1764 relationships, 57 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
