...
This project is indexed by GitNexus as **flowpilot** (8805 symbols, 20567 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
