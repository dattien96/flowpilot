...
This project is indexed by GitNexus as **flowpilot** (8981 symbols, 17463 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
