...
This project is indexed by GitNexus as **flowpilot** (9057 symbols, 21083 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
