...
This project is indexed by GitNexus as **flowpilot** (9110 symbols, 21180 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
