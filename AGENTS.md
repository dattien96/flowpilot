...
This project is indexed by GitNexus as **flowpilot** (4845 symbols, 9934 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
