...
This project is indexed by GitNexus as **flowpilot** (8796 symbols, 17095 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
