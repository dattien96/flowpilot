...
This project is indexed by GitNexus as **flowpilot** (7064 symbols, 13871 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
